...
export const gamesList = [
  {
    ...
    games: [{
      id: 0,
      answer: ["Robert Downey Jr.", "Robert Downey Jr", "Robert John Downey Jr.", "Robert John Downey Jr"],
    ...
    {
      id: 1,
      answer: ["Morgan Freeman", "Morgan Porterfield Freeman Jr.", "Morgan Porterfield Freeman Jr"],
    ...
    {
      id: 2,
      answer: ["Tom Hanks", "Tom Jeffrey Hanks"],
    ...
    {
      id: 3,
      answer: ["Jennifer Aniston", "Jennifer Joanna Aniston"],
    ...
    {
      id: 4,
      answer: ["Denzel Washington", "Denzel Hayes Washington Jr.", "Denzel Hayes Washington Jr"],
    ...
    {
      id: 5,
      answer: ["Keanu Reeves", "Keanu Charles Reeves"],
